...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i4.IAccountRepository>(
        () => _i5.AccountRepository(gh<_i6.Dio>()));
    ...
    gh.factory<_i10.RegisterFormBloc>(
        () => _i10.RegisterFormBloc(gh<_i7.IAuthFacade>()));
    ...
    gh.factory<_i13.AuthStatusBloc>(
        () => _i13.AuthStatusBloc(gh<_i7.IAuthFacade>()));
    gh.factory<_i14.ChangePasswordCubit>(
        () => _i14.ChangePasswordCubit(gh<_i7.IAuthFacade>()));
    gh.factory<_i15.ForgotPasswordCubit>(
        () => _i15.ForgotPasswordCubit(gh<_i7.IAuthFacade>()));
    return this;
  }
}
