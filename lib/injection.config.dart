...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i15.PaymentMethodBloc>(
        () => _i15.PaymentMethodBloc(gh<_i9.IMainFacade>()));
    gh.factory<_i16.ProductDetailBloc>(
        () => _i16.ProductDetailBloc(gh<_i9.IMainFacade>()));
    gh.factory<_i17.RegisterFormBloc>(
        () => _i17.RegisterFormBloc(gh<_i7.IAuthFacade>()));
    gh.factory<_i18.ShippingAddressesBloc>(
        () => _i18.ShippingAddressesBloc(gh<_i9.IMainFacade>()));
    gh.factory<_i19.AccountCubit>(
        () => _i19.AccountCubit(gh<_i5.IAccountRepository>()));
