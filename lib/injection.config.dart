...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i13.MainTabBloc>(() => _i13.MainTabBloc(gh<_i9.IAuthFacade>()));
    ...
    gh.factory<_i16.UpdateAccountBloc>(
        () => _i16.UpdateAccountBloc(gh<_i7.IAccountRepository>()));
    ...
    gh.factory<_i19.ChangePasswordCubit>(
        () => _i19.ChangePasswordCubit(gh<_i9.IAuthFacade>()));
    return this;
  }
}
