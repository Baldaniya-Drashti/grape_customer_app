...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.factory<_i9.LoginFormBloc>(
        () => _i9.LoginFormBloc(gh<_i7.IAuthFacade>()));
    gh.factory<_i10.OnboardingBloc>(() => _i10.OnboardingBloc());
    gh.factory<_i11.RegisterFormBloc>(
        () => _i11.RegisterFormBloc(gh<_i7.IAuthFacade>()));
    gh.factory<_i12.UpdateAccountBloc>(
        () => _i12.UpdateAccountBloc(gh<_i5.IAccountRepository>()));
    gh.factory<_i13.AccountCubit>(
        () => _i13.AccountCubit(gh<_i5.IAccountRepository>()));
    gh.factory<_i14.AuthStatusBloc>(
        () => _i14.AuthStatusBloc(gh<_i7.IAuthFacade>()));
    gh.factory<_i15.ChangePasswordCubit>(
    ...
    gh.factory<_i15.UpdateAccountBloc>(
        () => _i15.UpdateAccountBloc(gh<_i6.IAccountRepository>()));
