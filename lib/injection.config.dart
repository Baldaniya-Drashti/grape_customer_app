...
import 'package:grape_customer_app/domain/main/i_main_facade.dart' as _i11;
...
// initializes the registration of main-scope dependencies inside of GetIt
  _i1.GetIt init({
    ...
    gh.lazySingleton<_i11.IMainFacade>(
        () => _i12.MainFacade(apiService: gh<_i3.ApiService>()));
    gh.factory<_i13.LanguageBloc>(() => _i13.LanguageBloc());
    gh.factory<_i14.LoginFormBloc>(
        () => _i14.LoginFormBloc(gh<_i9.IAuthFacade>()));
    gh.factory<_i15.MainTabBloc>(() => _i15.MainTabBloc(
          gh<_i9.IAuthFacade>(),
    ...
    gh.factory<_i19.AccountCubit>(
        () => _i19.AccountCubit(gh<_i7.IAccountRepository>()));
    gh.factory<_i20.AuthStatusBloc>(
        () => _i20.AuthStatusBloc(gh<_i9.IAuthFacade>()));
