          ...
          children: [
            ...
            Row(
              ...
              children: [
                ...
                Visibility(
                  visible: state.checkoutDTO.shipping_address != null,
                    ...
                    onTap: () async {
                      var res = await context.router.push(
                        PageRouteInfo(
                          ...
                          args:
                              ShippingAddressesArgs(isFromChangeAddress: true),
                        ),
                      );
            ...
            Container(
              ...
              child: state.checkoutDTO.shipping_address == null
                  ? GestureDetector(
                      onTap: () async {
                        var res = await context.router.push(
                          PageRouteInfo(
