  ...
  Widget build(BuildContext context) {
    return BlocBuilder<ProductDetailBloc, ProductDetailState>(
      builder: (context, state) {
        if (state.isProductYouMayLikeLoading) {
          return ProductGridShimmerView();
        } else if (state.isErrorInAPI) {
          return Center(
            child: BaseText(text: 'Something wend wrond. Please try again!!'),
          );
        } else {
          return Visibility(
                    ...
                    children: [
                      Column(
                        ...
                        children: [
                          Center(
                            child: ClipRRect(
                              ...
                              child: state.getProductList[index].images?.first
                                      ...
                                      null
                                  ? CachedNetworkImage(
                                      imageUrl: state.getProductList[index]
                                              .images?.first.image ??
                                          "",
                          ...
                          BaseText(
                            text:
                                state.getProductList[index].product_name ?? "",
                            fontSize: 14,
                          ...
                          Row(
                            children: [
                              Visibility(
                                visible: state.getProductList[index].discount !=
                                    null,
                                child: BaseText(
                                  ...
                                  text: state.getProductList[index].discount !=
                                      ...
                                      ? NumberFormat.simpleCurrency(
                                          decimalDigits: num.tryParse(state
                                              ...
                                              ? 0
                                              : 2,
                                        ).format((state.getProductList[index]
                                                  .price ??
                                              0) -
                      ...
                      Positioned(
                        ...
                        child: GestureDetector(
                          onTap: () {
                            if (state.getProductList[index].is_favorite ==
                                true) {
                              context.read<ProductDetailBloc>().add(
                                      ProductDetailEvent
